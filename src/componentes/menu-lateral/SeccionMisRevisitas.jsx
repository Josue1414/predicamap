...
import { BookmarkPlus, ChevronUp, ChevronDown, Navigation, Share2, Edit, Trash2, Download, Upload, Info } from 'lucide-react';
      ...
      {acordeonActivo === 'revisitas' && (
        <>
          <div className="bg-amber-50 dark:bg-amber-900/20 px-3 py-2 border-t border-b border-amber-100 dark:border-amber-900/50 flex items-start gap-2">
            ...
            <p className="text-[10px] font-bold text-amber-800 dark:text-amber-400 uppercase">Tus revisitas solo viven en tu dispositivo, no se muestran a los demás.</p>
          </div>
          <div className="p-3 bg-white dark:bg-slate-950 max-h-96 overflow-y-auto space-y-2 scroll-limpio">
